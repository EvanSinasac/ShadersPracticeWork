...
cCrystal01Object::cCrystal01Object(glm::vec3 startPosition, Node* startNode)
{
	...
	this->m_Mesh->meshName = "dfk_crystal_01_XYZ_N_RGBA_UV_transformed.ply";		// lol, I just noticed that there's multiple chair models in this
...
cCrystal01Object::~cCrystal01Object()
{

}

void cCrystal01Object::Update(float deltaTime)
{
