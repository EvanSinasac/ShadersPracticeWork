...
cBedObject::cBedObject(glm::vec3 startPosition, Node* startNode)
{
	...
	this->m_Mesh->meshName = "dfk_bed_single_01_XYZ_N_RGBA_UV_transformed.ply";
	...
	this->m_Mesh->textureNames[1] = "dfk_bed_single_01_basecolor.bmp";
	this->m_Mesh->textureNames[2] = "dfk_bed_single_01_normal.bmp";
	this->m_Mesh->textureNames[3] = "dfk_bed_single_01_SmMetAO.bmp";
	...
	this->m_LowResMesh->textureNames[1] = "dfk_bed_single_01_basecolor.bmp";
	this->m_Mesh->textureRatios[1] = 1.0f;
}
cBedObject::~cBedObject()
{

}

void cBedObject::Update(float deltaTime)
{
