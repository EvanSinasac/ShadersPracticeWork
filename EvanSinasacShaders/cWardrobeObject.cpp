...
cWardrobeObject::cWardrobeObject(glm::vec3 startPosition, Node* startNode)
{
	...
	this->m_Mesh->meshName = "dfk_wardrobe_01_XYZ_N_RGBA_UV.ply";		// lol, I just noticed that there's multiple chair models in this
	...
	this->m_Mesh->textureNames[1] = "dfk_wardrobe_01_basecolor.bmp";
	this->m_Mesh->textureNames[2] = "dfk_wardrobe_01_normal.bmp";
	this->m_Mesh->textureNames[3] = "dfk_wardrobe_01_SmMetAO.bmp";
	...
	this->m_LowResMesh->textureNames[1] = "dfk_wardrobe_01_basecolor.bmp";
	this->m_Mesh->textureRatios[1] = 1.0f;
}
cWardrobeObject::~cWardrobeObject()
{

}

void cWardrobeObject::Update(float deltaTime)
{
